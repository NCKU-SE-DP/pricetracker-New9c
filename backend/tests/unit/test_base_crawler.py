...
class TestNewsCrawlerBase(unittest.TestCase):
    ...
    def test_search(self):
        headline = self.crawler.get_headline(search_term="test", page=1)
        self.assertEqual(len(headline), 1)
        self.assertEqual(headline[0].title, "Test Article")
        self.assertEqual(headline[0].url, "https://www.example.com/article")
